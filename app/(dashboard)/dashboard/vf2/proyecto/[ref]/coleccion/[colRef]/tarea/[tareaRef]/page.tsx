...
// SERVER — detalle de tarea vf2_ con grid de celdas, roles, y co-edición Yjs
...
export default async function Vf2TareaPage({
  ...
  // Cargar roles, sheets, usuarios, equipos y métrica en paralelo
  ...
  // Usuarios con su rol de empresa (join user_roles)
